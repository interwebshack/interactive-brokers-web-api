...
BASE_API_URL = os.environ.get('BASE_API_URL', "https://localhost:5055/v1/api")
ACCOUNT_ID = os.environ.get('IBKR_ACCOUNT_ID', "U1234567")

# Ensure HTTPS verification is disabled for testing
